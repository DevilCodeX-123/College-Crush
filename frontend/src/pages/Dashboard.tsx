...
const Dashboard = () => {
    ...
    return (
        <div className="flex-1">
            {/* Header */}
            <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 md:mb-12 pt-2">
                ...
                <div className="flex items-center space-x-3">
                    <div className="text-right mr-1">
                        ...
                        <p className="text-[10px] text-gray-500 uppercase tracking-widest mt-1">Visits: {user?.visitCount || 0}</p>
                    </div>
                    <div
                        onClick={() => navigate('/profile')}
                        className={`w-11 h-11 rounded-2xl bg-gradient-to-br ${theme.profileBorder} p-[1px] cursor-pointer hover:scale-105 transition-transform`}
                    >
                        <div className="w-full h-full rounded-[14px] bg-[#0a0a0c] flex items-center justify-center overflow-hidden">
                            {user?.profilePhoto ? <img src={user.profilePhoto} alt="" /> : <User className="w-5 h-5 text-gray-400" />}
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                {/* Confession Post Box */}
                <div className="lg:col-span-2 col-span-1 space-y-6 md:space-y-8">
