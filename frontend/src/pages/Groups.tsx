        ...
        <div className="min-h-screen bg-[#0a0a0c] text-white p-8 overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    <div>
                        <h1 className="text-5xl font-black tracking-tighter mb-2">Campus Hubs</h1>
                        <p className="text-gray-500 text-sm uppercase tracking-[0.2em] font-bold">Find your tribe or start a movement</p>
                    </div>
                    <Button 
                                                ...
                                                {activeTab === 'private' ? (
                                                    <Button 
                                                        ...
                                                        className={`rounded-xl h-12 px-6 font-black text-xs uppercase tracking-widest ${
                                                            requestSent === group._id ? 'bg-green-600/20 text-green-500' : 'bg-white/5 hover:bg-white/10'
                                                        }`}
                                                    >
